...
function linkEmbedsHTML(text) {
  ...
  const out = [];
  let m;
  while (out.length < EMBED_MAX && (m = re.exec(src))) {
...
try { if (typeof module !== 'undefined') module.exports = { linkEmbedsHTML, embedForUrl, cleanEmbedUrl, stripEmbedIgnored }; } catch {}
