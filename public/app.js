...
// ---------- emoji / GIF picker ----------
function openPicker(mode = 'insert', mid = null) {
  S.picker = { mode, mid };
...
$('#btn-settings').onclick = () => openSettings('profile');
...
// ---------- global closers ----------
 document.addEventListener('click', (e) => {
  if (!e.target.closest('#picker') && !e.target.closest('#btn-emoji') && !e.target.closest('[data-act="react"]')) closePicker();
