 ...
 *   voice-aware and draft-safe) checks the version right away Ã¢â‚¬â€ the worker
 *   never force-reloads pages itself, so a fresh SW install can't yank a
 *   tab out from under its first load.
 */
const CACHE = 'campfire-v654';
const SHELL = ['/', '/index.html', '/styles.css', '/embeds.js', '/js/core.js', '/js/router.js', '/js/auth.js', '/js/noise.js', '/js/servers.js', '/js/messages.js', '/js/socket.js', '/js/ui.js', '/js/voice.js', '/js/actions.js', '/js/rail.js', '/js/home.js', '/js/pins.js', '/js/share.js', '/js/compose.js', '/js/story-edit.js', '/js/stories.js', '/js/viewonce.js', '/js/pickers.js', '/js/crop.js', '/js/settings.js', '/js/admin.js', '/js/security.js', '/js/final.js', '/js/native.js', '/manifest.webmanifest', '/icons/icon-192.png', '/icons/icon-512.png', '/icons/icon-maskable-512.png', '/icons/apple-touch-icon.png', '/icons/campfire-logo.png', '/favicon.ico', '/favicon-32.png', '/emoji.json'];
