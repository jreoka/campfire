// Shared zero-dependency PNG helpers (8-bit, non-interlaced, truecolor+alpha).
// Used by gen-icons.js (web/PWA icons) and gen-android-icons.js (APK launcher
// icons). Single source of truth for the resampling/compositing math so both
// pipelines stay byte-consistent.
const fs = require('fs');
...
module.exports = { decodePNG, encodePNG, resample, compositeOver };
