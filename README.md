...
- 📸 **Stories** — post a photo or video (shoot it in-app or pick one), hit Next, then choose who sees it: all friends, everyone on the instance, any servers, or individual friends; it lives 24 hours, the ring shows a thumbnail of the story itself, and each server gets its own stories area
- 👁️ **View once** — send a photo or video to as many friends as you like; each gets their own DM, it stays locked until they open it (one view + one replay), and the media is deleted once the view is used
