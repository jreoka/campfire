...
- 📸 **Stories** — post a photo or video (shoot it in-app or pick one) for friends, everyone on the instance, or any servers; it lives 24 hours, the ring shows a thumbnail of the story itself, and each server gets its own stories area
